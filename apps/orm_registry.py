...
def import_all_models() -> None:
    ...
    from domain_intake.models.genre import GalleryItemGenre, Genre  # noqa: F401
    ...
    from titanic.adapter.outbound.orm.passenger_rose_model_orm import (
        PassengerRoseModelOrm,  # noqa: F401
    )
