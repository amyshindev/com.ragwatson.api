...
class VisualRating(Base):
    ...
    loop_smoothness_score: Mapped[int | None] = mapped_column(Integer, nullable=True)
    beat_sync_score: Mapped[int | None] = mapped_column(Integer, nullable=True)
