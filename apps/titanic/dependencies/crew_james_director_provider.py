...
from titanic.adapter.outbound.pg.crew_james_director_repository import CrewJamesDirectorPgRepository
...
def get_james_director_repository(
    ...
    return CrewJamesDirectorPgRepository(session=db)
...
get_crew_james_director_use_case = get_james_director_use_case
